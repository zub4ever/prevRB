...
<div class=" cartone-b jumbotron d-flex justify-content-center bg-secondary">
  <div class="text-black">
    <div class="ml-auto mt-auto mr-auto mb-auto d-flex ">
      <h2 class="text-left font-weight-bold text-uppercase text-white">Comitê de Investimentos</h2>
    </div>
  </div>
</div>
<div class="container pb-3 mb-3 ">
  <div class="row mt-5 mb-5 py-5 d-flex justify-content-space-between">
    <div class="col-sm-12 col-lg-3 mt-3">
      <a href="historico-comite.php" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Histórico</h6>
      </a>
    </div>
    <div class="col-sm-12 col-lg-3 mt-3">
      <a href="membros-comite.php" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Membros do comitê</h6>
      </a>
    </div>
    <div class="col-sm-12 col-lg-3 mt-3">
      <a href="relatorios_comite.php" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Relatórios</h6>
      </a>
    </div>
    <div class="col-sm-12 col-lg-3 mt-3">
    ...
    <div class="col-sm-12 col-lg-3 mt-3">
      <a href="atasDasReunioes-comite.php" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Atas das Reuniões</h6>
      </a>
    </div>
    <div class="col-sm-12 col-lg-3 mt-3">
      <a href="calendario-comite.php" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Calendário de reuniões</h6>
      </a>
    </div>
    <div class="col-sm-12 col-lg-3 mt-3">
      <a href="documentos/comite/regimento_interno.pdf" class="btn btn-primary" style="width: 100%;">
