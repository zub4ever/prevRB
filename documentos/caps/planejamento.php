    ...
    <div class="row">
      <div class="col-lg-12 col-md-12" align="center">
        <div class="btn-group mt-10" role="group">
          <a href="#" class="btn btn-primary text-uppercase mt-10">Planejamento 2020</a>  
        </div>
        <div class="btn-group mt-10" role="group">
          <div class="button-group-area" align="center">
            ...
            <div aria-labelledby="btnGroupDrop1" class="dropdown-menu" id="drop2">
                ...
                <a class="dropdown-item" href="http://rbprev.riobranco.ac.gov.br/noticias/index.php/2019/03/28/equipe-do-rbprev-realiza-construcao-do-planejamento-estrategico/">Resumo</a>
